...
export default function Home() {
  return (
    <>
        ...
        <div className="p-3 flex mob:flex-col m-auto max-w-6xl justify-between items-center">
          <div className="logo mob:border-b mob:border-b-gray-200 flex justify-center items-center">
            ...
            <div className="text flex flex-col justify-start items-start">
              ...
              <p className="text-xs"> GLA University</p>
          ...
          <div className="links mob:py-3 flex justify-center items-center space-x-5">
            ...
            <Link href="https://www.linkedin.com/company/gdsc-glau/"><div className="cursor-pointer linkedin">
            ...
            <Link href="https://www.instagram.com/gdscglau/"><div className="cursor-pointer insta">
            ...
            <Link href="https://twitter.com/GdscGlau/"><div className="cursor-pointer twitter">
      ...
      <div className="  w-full p-2 text-center bg-gray-900 text-gray-300">Devloped By <a href="https://github.com/pradhumn14" className="text-orange-400">Pradhumn Agrawal</a> </div>
    </>
  )
}
